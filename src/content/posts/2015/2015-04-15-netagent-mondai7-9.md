...
![normal-ida1.png](/public/assets/images/2015/04/15/normal-ida1.png)

IDAに解析させて表示を見てみると、おもむろに正解を表示するらしい*aCorrectKeyIsS*がみつかります。
ここまで来る過程をアセンブリ表示で追っていくことにします。

![normal-ida2.png](/public/assets/images/2015/04/15/normal-ida2.png)
...
![normal-ida3.png](/public/assets/images/2015/04/15/normal-ida3.png)
...
![normal-ida4.png](/public/assets/images/2015/04/15/normal-ida4.png)
...
![normal-ida5.png](/public/assets/images/2015/04/15/normal-ida5.png)


サブルーチン *sub_4011C0* のはじめの方では、ループインデックス（以下、i）を0にしたりと、forループの初期化が行われている様子がつかめます。このループの中の処理を見てみます。

![normal-ida6.png](/public/assets/images/2015/04/15/normal-ida6.png)
...
![normal-ida7.png](/public/assets/images/2015/04/15/normal-ida7.png)
...
![normal-ida8.png](/public/assets/images/2015/04/15/normal-ida8.png)
...
![TochuKasou.png](/public/assets/images/2015/04/15/TochuKasou.png)
...
![mondai8-files.png](/public/assets/images/2015/04/15/mondai8-files.png)


こういったCTF系の問題でイメージファイルが配布されるときは、フォレンジック問題であると相場が決まっているので、TrueCryptでマウントしたらAutopsyで調査します。

![autopsy.png](/public/assets/images/2015/04/15/autopsy.png)

マウントした際に表示されていたファイルになかった「今日の本.xlsx」という削除されたファイルが見つかりました。怪しいですね。
復元してファイルを開いてみます。


![todaysbook1.png](/public/assets/images/2015/04/15/todaysbook1.png)
![todaysbook2.png](/public/assets/images/2015/04/15/todaysbook2.png)
![todaysbook3.png](/public/assets/images/2015/04/15/todaysbook3.png)
...
![print-book.png](/public/assets/images/2015/04/15/print-book.png)
...
引数に先ほど作成した[kidanclub.txt](/public/assets/data/2015/04/15/kidanclub.txt)を与えて実行してみると、漢字8文字のパスワードを得ることができました。
...
![mondai9-wireshark1.png](/public/assets/images/2015/04/15/mondai9-wireshark1.png)

ざっと目を通した感じ、`tcpdump -f 'tcp port 80'`によって、fast-uploader.comにアクセスしている様子をキャプチャしたもののようです。

![mondai9-wireshark2.png](/public/assets/images/2015/04/15/mondai9-wireshark2.png)

httpリクエストで絞り込むと、POSTメソッドによってファイルを幾つかアップロードしているようです。

![mondai9-wireshark3.png](/public/assets/images/2015/04/15/mondai9-wireshark3.png)
...
![mondai9-networkminer.png](/public/assets/images/2015/04/15/mondai9-networkminer.png)
...
![office-files.png](/public/assets/images/2015/04/15/office-files.png)

どのOfficeファイルにも文字の記入はなく、答えらしきものがみつかりません。
ファイル名で検索してみたりいろいろしたあと、ファイルのメタ情報を詮索してみることにしたところ、文字化けしたWordファイルにそれらしきものがあることに気づきました。

![word-property.png](/public/assets/images/2015/04/15/word-property.png)
