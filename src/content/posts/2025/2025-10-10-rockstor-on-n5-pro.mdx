...
OSSのNAS用OSの顔ぶれを久々に調べてみたものの、FreeNAS→TrueNASやNAS4Free→XigmaNASと名前が変わったりするくらいで、メジャーどころの顔ぶれは10年前と変わっていなかったことに驚いた。
...
以前に記事にした時にはRockstor Inc.が開発と紹介していたものの、今はOpen Collectiveの一プロジェクトとして非営利で開発されるようになっていた。
...
非営利化のトレードオフとして、有償サポートが停止されている。有償のインシデントベースサポートを追加予定と謳っているが、しばらく追加されそうに無い。
...
起動時にUSBメモリが刺さっていれば中の鍵を使って復号してくれ、なければ暗号化されたままになる。
