...
![n5-pro](/public/assets/images/2025/10/10/n5-pro.jpeg)
...
![install-proxmox](/public/assets/images/2025/10/10/install-proxmox.jpeg)
...
![passthrough-pcie](/public/assets/images/2025/10/10/passthrough-pcie.png)
![pcie-device-select](/public/assets/images/2025/10/10/pcie-device-select.png)

あとはRockstorのインストーラーISOから起動し、仮想ディスクにシステムをインストールしたら普通に動くRockstorのできあがり。

![rockstor-dashboard](/public/assets/images/2025/10/10/rockstor-dashboard.png)
...
![luks-setup](/public/assets/images/2025/10/10/luks-setup.png)

暗号化設定ができたら一覧の名前の横のボタンから、次は自動マウントの設定を行う。
鍵をシステムドライブに保存し、起動時に自動で復号するのが推奨設定なので、画面の説明に従って進める。

![luks-automount](/public/assets/images/2025/10/10/luks-automount.png)

一度再起動してみて暗号化が解除された状態でマウントされていることを確認。
Poolsに移動してデータプールを作成する。

![raid-setup](/public/assets/images/2025/10/10/raid-setup.png)
...
![smb-apple-device](/public/assets/images/2025/10/10/smb-apple-device.png)
